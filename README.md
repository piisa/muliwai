# Intro
This is a fork and clone of https://github.com/ontocord/muliwai  that only includes PII prpcessing functionality. We can expperiment with different ways to create a PII framework that can interoperate with other PII libraries such as Presidio.
